...
def get_image_info(image_path, max_results=20):
    client = vision.ImageAnnotatorClient()
...
def draw_rectangles(image_path,objects):
    ...
    for i in bounding_box_list:
        img = cv2.rectangle(img,(i[0],i[1]),(i[2],i[3]),(0,255,0),3)
        cv2.putText(img, str(counter), (i[0], i[1]-10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (0,255,0), 2)
        counter+=1
